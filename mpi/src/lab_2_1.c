...
// Napisati MPI program koji pronalazi maksimalnu vrednost u delu matrice reda
// n(n - parno) koga čine vrste matrice sa parnim indeksom(i = 0, 2, 4, ...).
// Matrica je inicijalizovana u master procesu(P0).
// Svaki proces treba da dobije elemente vrsta sa parnim indeksom iz odgovarajućih
// n / p kolona(p - broj procesa, n deljivo sa p) i nađe lokalni maksimum.Na taj način,
// P0 dobija elemente vrsta sa parnim indeksom iz prvih n / p kolona i nalazi
// lokalni maksimum, P1 dobija elemente kolona sa parnim indeksom iz sledećih n / p
// kolona i nalazi lokalni maksimum itd.Nakon toga, u master procesu se izračunava i na ekranu
...
int main(int argc, char **argv)
{
	...
	int bl = 0;
	int extent = 2 * mat_dim * sizeof(int);
